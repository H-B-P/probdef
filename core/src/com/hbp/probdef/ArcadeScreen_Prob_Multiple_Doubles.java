...
public class ArcadeScreen_Prob_Multiple_Doubles extends ArcadeScreen_Prob_Multiple {
	
	final ProbDef game;

	
	public ArcadeScreen_Prob_Multiple_Doubles(final ProbDef gam, boolean camp) {
